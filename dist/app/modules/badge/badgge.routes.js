...
router.get("/", auth_1.default, badge_controllers_1.streak_controllers.fetch_all);
// Route for create streak
router.post("/", auth_1.default, badge_controllers_1.streak_controllers.create_one);
